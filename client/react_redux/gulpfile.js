...
gulp.task('copy-html-dev', function () {
    ...
    var sources = gulp.src(['app/env/dev.js'], { read: false });
...
gulp.task('copy-env', function () {
    return gulp.src('app/env/*').pipe(gulp.dest('.tmp/env'));
});

gulp.task('pre-build', ['compile-scripts', 'copy-html-prod', 'styles'], function () {
...
gulp.task('serve', ['compile-scripts', 'copy-env', 'copy-html-dev', 'connect', 'watch'], function () {
