    ...
    render () {
        ...
        return (
            <div>
                ...
                <i onClick={this.handleOnClickOpenModal} title="Add tag (max allowed is 3)" style={shouldShowAddTagButton ? {color: "#9627ba", padding: "5px"} : {display:"none"}} className="plus icon link"></i>
            </div>
        );
    }
}
